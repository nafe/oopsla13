...
// ---------------------------------------------------------------------------
#define ilog2(x) \
  (__ite_dtype(x == 1, 0, (__ite_dtype((2 <= x) & (x < 4), 1, (__ite_dtype((4 <= x) & (x < 8), 2, (__ite_dtype((8 <= x) & (x < 16), 3, (__ite_dtype((16 <= x) & (x < 32), 4, (__ite_dtype((32 <= x) & (x < 64), 5, (__ite_dtype((64 <= x) & (x < 128), 6, 7))))))))))))))

#define term(x,i) \
  (x - (__ite_dtype((0 <= i) & isone(0, (x+1)), 1, 0) + __ite_dtype((1 <= i) & isone(1, (x+1)), 2, 0) + __ite_dtype((2 <= i) & isone(2, (x+1)), 4, 0) + __ite_dtype((3 <= i) & isone(3, (x+1)), 8, 0) + __ite_dtype((4 <= i) & isone(4, (x+1)), 16, 0) + __ite_dtype((5 <= i) & isone(5, (x+1)), 32, 0) + __ite_dtype((6 <= i) & isone(6, (x+1)), 64, 0)))

#define downsweep_summation(result,ghostsum,x) \
  (result[x] == (raddf(raddf(raddf(raddf(raddf(raddf(raddf(__ite_rtype(isone(6,(x+1)) & (6 < ilog2(x+1)), ghostsum[term(x,6)], 0),__ite_rtype(isone(5,(x+1)) & (5 < ilog2(x+1)), ghostsum[term(x,5)], 0)),__ite_rtype(isone(4,(x+1)) & (4 < ilog2(x+1)), ghostsum[term(x,4)], 0)),__ite_rtype(isone(3,(x+1)) & (3 < ilog2(x+1)), ghostsum[term(x,3)], 0)),__ite_rtype(isone(2,(x+1)) & (2 < ilog2(x+1)), ghostsum[term(x,2)], 0)),__ite_rtype(isone(1,(x+1)) & (1 < ilog2(x+1)), ghostsum[term(x,1)], 0)),__ite_rtype(isone(0,(x+1)) & (0 < ilog2(x+1)), ghostsum[term(x,0)], 0)),ghostsum[x])))

#define downsweep_core(offset,result,ghostsum,x) \
  (__implies(((offset == 256) | \
   ...
   __implies(((offset <= 128) & updated(x,64)) | ((offset <= 64) & updated(x,32)) | ((offset <= 32) & updated(x,16)) | ((offset <= 16) & updated(x,8)) | ((offset <= 8) & updated(x,4)) | ((offset <= 4) & updated(x,2)) | ((offset <= 2) & updated(x,1)), downsweep_summation(result,ghostsum,x)))

#if defined(INC_ENDSPEC) && defined(BINOP_ADD)
#define downsweep_nooverflow(offset,result,ghostsum,x) \
  __implies(((offset <= 128) & updated(x,64)) | ((offset <= 64) & updated(x,32)) | ((offset <= 32) & updated(x,16)) | ((offset <= 16) & updated(x,8)) | ((offset <= 8) & updated(x,4)) | ((offset <= 4) & updated(x,2)) | ((offset <= 2) & updated(x,1)), __add_noovfl(__ite_rtype(isone(6,(x+1)) & (6 < ilog2(x+1)), ghostsum[term(x,6)], 0), __ite_rtype(isone(5,(x+1)) & (5 < ilog2(x+1)), ghostsum[term(x,5)], 0), __ite_rtype(isone(4,(x+1)) & (4 < ilog2(x+1)), ghostsum[term(x,4)], 0), __ite_rtype(isone(3,(x+1)) & (3 < ilog2(x+1)), ghostsum[term(x,3)], 0), __ite_rtype(isone(2,(x+1)) & (2 < ilog2(x+1)), ghostsum[term(x,2)], 0), __ite_rtype(isone(1,(x+1)) & (1 < ilog2(x+1)), ghostsum[term(x,1)], 0), __ite_rtype(isone(0,(x+1)) & (0 < ilog2(x+1)), ghostsum[term(x,0)], 0), ghostsum[x]))
...
#define downsweep_barrier(tid,offset,result,ghostsum) \
  (__implies((tid < 128) & (offset > 2), downsweep(offset,result,ghostsum,ai_idx(1,tid))) & \
   __implies((tid < 64) & (offset > 4), downsweep(offset,result,ghostsum,ai_idx(2,tid))) & \
   __implies((tid < 32) & (offset > 8), downsweep(offset,result,ghostsum,ai_idx(4,tid))) & \
   __implies((tid < 16) & (offset > 16), downsweep(offset,result,ghostsum,ai_idx(8,tid))) & \
   __implies((tid < 8) & (offset > 32), downsweep(offset,result,ghostsum,ai_idx(16,tid))) & \
   __implies((tid < 4) & (offset > 64), downsweep(offset,result,ghostsum,ai_idx(32,tid))) & \
   __implies((tid < 2) & (offset > 128), downsweep(offset,result,ghostsum,ai_idx(64,tid))) & \
   __implies((tid < 1),                downsweep(offset,result,ghostsum,ai_idx(div2(offset),tid))) & \
   __implies((tid < 1),                downsweep(offset,result,ghostsum,bi_idx(128,tid))) & \
   __implies((tid < 1) & (offset == 128), downsweep(offset,result,ghostsum,lf_ai_idx(128,tid))) & \
   __implies((tid < 3) & (offset == 64), downsweep(offset,result,ghostsum,lf_ai_idx(64,tid))) & \
   __implies((tid < 7) & (offset == 32), downsweep(offset,result,ghostsum,lf_ai_idx(32,tid))) & \
   __implies((tid < 15) & (offset == 16), downsweep(offset,result,ghostsum,lf_ai_idx(16,tid))) & \
   __implies((tid < 31) & (offset == 8), downsweep(offset,result,ghostsum,lf_ai_idx(8,tid))) & \
   __implies((tid < 63) & (offset == 4), downsweep(offset,result,ghostsum,lf_ai_idx(4,tid))) & \
   __implies((tid < 127) & (offset == 2), downsweep(offset,result,ghostsum,lf_ai_idx(2,tid))) & \
   __implies((tid < 1) & (offset == 128), downsweep(offset,result,ghostsum,lf_bi_idx(128,tid))) & \
   __implies((tid < 3) & (offset == 64), downsweep(offset,result,ghostsum,lf_bi_idx(64,tid))) & \
   __implies((tid < 7) & (offset == 32), downsweep(offset,result,ghostsum,lf_bi_idx(32,tid))) & \
   __implies((tid < 15) & (offset == 16), downsweep(offset,result,ghostsum,lf_bi_idx(16,tid))) & \
   __implies((tid < 31) & (offset == 8), downsweep(offset,result,ghostsum,lf_bi_idx(8,tid))) & \
   __implies((tid < 63) & (offset == 4), downsweep(offset,result,ghostsum,lf_bi_idx(4,tid))) & \
   __implies((tid < 127) & (offset == 2), downsweep(offset,result,ghostsum,lf_bi_idx(2,tid))))

#define downsweep_d_offset \
  (((d == 2) & (offset == 256)) | ((d == 4) & (offset == 128)) | ((d == 8) & (offset == 64)) | ((d == 16) & (offset == 32)) | ((d == 32) & (offset == 16)) | ((d == 64) & (offset == 8)) | ((d == 128) & (offset == 4)) | ((d == 256) & (offset == 2)))
...
#define downsweep_barrier_permissions(tid,offset,result,ghostsum) \
  {if ((tid < 128) & (offset > 2)) downsweep_permissions(offset,result,ghostsum,ai_idx(1,tid)) \
   if ((tid < 64) & (offset > 4)) downsweep_permissions(offset,result,ghostsum,ai_idx(2,tid)) \
   if ((tid < 32) & (offset > 8)) downsweep_permissions(offset,result,ghostsum,ai_idx(4,tid)) \
   if ((tid < 16) & (offset > 16)) downsweep_permissions(offset,result,ghostsum,ai_idx(8,tid)) \
   if ((tid < 8) & (offset > 32)) downsweep_permissions(offset,result,ghostsum,ai_idx(16,tid)) \
   if ((tid < 4) & (offset > 64)) downsweep_permissions(offset,result,ghostsum,ai_idx(32,tid)) \
   if ((tid < 2) & (offset > 128)) downsweep_permissions(offset,result,ghostsum,ai_idx(64,tid)) \
   if (tid < 1)                   downsweep_permissions(offset,result,ghostsum,ai_idx(div2(offset),tid)) \
   if (tid < 1)                   downsweep_permissions(offset,result,ghostsum,bi_idx(128,tid)) \
   if ((tid < 1) & (offset == 128)) downsweep_permissions(offset,result,ghostsum,lf_ai_idx(128,tid)) \
   if ((tid < 3) & (offset == 64)) downsweep_permissions(offset,result,ghostsum,lf_ai_idx(64,tid)) \
   if ((tid < 7) & (offset == 32)) downsweep_permissions(offset,result,ghostsum,lf_ai_idx(32,tid)) \
   if ((tid < 15) & (offset == 16)) downsweep_permissions(offset,result,ghostsum,lf_ai_idx(16,tid)) \
   if ((tid < 31) & (offset == 8)) downsweep_permissions(offset,result,ghostsum,lf_ai_idx(8,tid)) \
   if ((tid < 63) & (offset == 4)) downsweep_permissions(offset,result,ghostsum,lf_ai_idx(4,tid)) \
   if ((tid < 127) & (offset == 2)) downsweep_permissions(offset,result,ghostsum,lf_ai_idx(2,tid)) \
   if ((tid < 1) & (offset == 128)) downsweep_permissions(offset,result,ghostsum,lf_bi_idx(128,tid)) \
   if ((tid < 3) & (offset == 64)) downsweep_permissions(offset,result,ghostsum,lf_bi_idx(64,tid)) \
   if ((tid < 7) & (offset == 32)) downsweep_permissions(offset,result,ghostsum,lf_bi_idx(32,tid)) \
   if ((tid < 15) & (offset == 16)) downsweep_permissions(offset,result,ghostsum,lf_bi_idx(16,tid)) \
   if ((tid < 31) & (offset == 8)) downsweep_permissions(offset,result,ghostsum,lf_bi_idx(8,tid)) \
   if ((tid < 63) & (offset == 4)) downsweep_permissions(offset,result,ghostsum,lf_bi_idx(4,tid)) \
   if ((tid < 127) & (offset == 2)) downsweep_permissions(offset,result,ghostsum,lf_bi_idx(2,tid))}
...
#define final_downsweep_barrier(tid,result,ghostsum) \
  (__implies((tid < 1), downsweep(/*offset=*/2,result,ghostsum,ai_idx(1,tid))) & \
   __implies((tid < 1), downsweep(/*offset=*/2,result,ghostsum,bi_idx(128,tid))) & \
   __implies((tid < 127), downsweep(/*offset=*/2,result,ghostsum,lf_ai_idx(2,tid))) & \
   __implies((tid < 127), downsweep(/*offset=*/2,result,ghostsum,lf_bi_idx(2,tid))))

#if defined(SPEC_THREADWISE)
#define upsweep_instantiation \
  tid, (tid+1), div2((tid+1)), div2(div2((tid+1))), div2(div2(div2((tid+1)))), div2(div2(div2(div2((tid+1))))), div2(div2(div2(div2(div2((tid+1)))))), div2(div2(div2(div2(div2(div2((tid+1))))))), other_tid, (other_tid+1), div2((other_tid+1)), div2(div2((other_tid+1))), div2(div2(div2((other_tid+1)))), div2(div2(div2(div2((other_tid+1))))), div2(div2(div2(div2(div2((other_tid+1)))))), div2(div2(div2(div2(div2(div2((other_tid+1)))))))
...
#define upsweep_instantiation \
  x2t(tid), (x2t(tid)+1), div2((x2t(tid)+1)), div2(div2((x2t(tid)+1))), div2(div2(div2((x2t(tid)+1)))), div2(div2(div2(div2((x2t(tid)+1))))), div2(div2(div2(div2(div2((x2t(tid)+1)))))), div2(div2(div2(div2(div2(div2((x2t(tid)+1))))))), x2t(other_tid), (x2t(other_tid)+1), div2((x2t(other_tid)+1)), div2(div2((x2t(other_tid)+1))), div2(div2(div2((x2t(other_tid)+1)))), div2(div2(div2(div2((x2t(other_tid)+1))))), div2(div2(div2(div2(div2((x2t(other_tid)+1)))))), div2(div2(div2(div2(div2(div2((x2t(other_tid)+1)))))))
